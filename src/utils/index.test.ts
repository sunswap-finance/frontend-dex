...
import { TokenAmount, Token, ChainId, Percent, JSBI } from '@sunswap/sunswap-finance-sdk'
...
describe('utils', () => {
  describe('#getEtherscanLink', () => {
    ...
    it('enum', () => {
      expect(getEtherscanLink(ChainId.TESTNET, 'abc', 'address')).toEqual('https://bscscan.com/address/abc')
    })
  })
